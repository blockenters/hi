...
조편성 및 일정공유 : https://docs.google.com/spreadsheets/d/12HcwntDo4-z8NhOrNh5e7IOI9C-OAXwZotT-0LzthUA/edit?usp=sharing
...
내용 : AI Automation 융합 플랫폼 개발 ( 위의 2개 프로젝트를 하나의 서비스로 합치고, 추가 기능 개발 )
