...
미니 프로젝트 1 : 분석 예측 시스템 개발 ( 데이터를 기반으로 분석 시스템을 스트림릿으로 개발 )

데이터 : 

---

미니 프로젝트 2 : 판매현황 관리 자동화 및 추천 시스템 개발 ( 데이터를 기반으로 분석 시스템을 스트림릿으로 개발 )

데이터 : https://block-edu.s3.ap-northeast-2.amazonaws.com/%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8+%EB%8D%B0%EC%9D%B4%ED%84%B0.zip

--- 

메인 프로젝트 : AI Automation 융합 플랫폼 개발 ( 위의 2개 프로젝트를 하나의 서비스로 합쳐서 개발 )
...
- 알람소리 파일 : https://drive.google.com/file/d/1Yln8cumCUlU6EzJp970UveQFdNdoXt9t/view?usp=sharing
